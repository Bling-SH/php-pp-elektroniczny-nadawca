...
class PotwierdzenieOdbioruPaczkowaType extends AbstractStructBase
{
     ...
     * @param int $ilosc
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\PotwierdzenieOdbioruPaczkowaType
     */
     ...
     * Set sposob value.
     *
     * @uses \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::valueIsValid()
     * @uses \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::getValidValues()
     *
    ...
    public function setSposob($sposob = null)
    {
        ...
        if (!\Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::valueIsValid($sposob)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType', is_array($sposob) ? implode(', ', $sposob) : var_export($sposob, true), implode(', ', \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::getValidValues())), __LINE__);
        }
        $this->sposob = $sposob;
