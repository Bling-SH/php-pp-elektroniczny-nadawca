...
class WyslijLinkaOStatusieEZwrotu extends AbstractStructBase
{
    ...
    /**
     * This method is responsible for validating the values passed to the setGuidZgodaEZwrot method
     ...
     */
    public static function validateGuidZgodaEZwrotForArrayConstraintsFromSetGuidZgodaEZwrot(array $values = [])
    {
        $message = '';
        $invalidValues = [];
    ...
    /**
     * This method is responsible for validating the value passed to the setGuidZgodaEZwrot method
     * This method is willingly generated in order to preserve the one-line inline validation within the setGuidZgodaEZwrot method
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateGuidZgodaEZwrotForLengthConstraintFromSetGuidZgodaEZwrot($values)
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $wyslijLinkaOStatusieEZwrotuGuidZgodaEZwrotItem) {
            // validation for constraint: length(32)
            if (32 !== mb_strlen($wyslijLinkaOStatusieEZwrotuGuidZgodaEZwrotItem)) {
     ...
     * @param string[] $guidZgodaEZwrot
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\WyslijLinkaOStatusieEZwrotu
     */
    public function setGuidZgodaEZwrot(array $guidZgodaEZwrot = [])
    {
        // validation for constraint: array
        if ('' !== ($guidZgodaEZwrotArrayErrorMessage = self::validateGuidZgodaEZwrotForArrayConstraintsFromSetGuidZgodaEZwrot($guidZgodaEZwrot))) {
