...
class AddReklamacjeResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(array $values = [])
    {
        ...
        foreach ($values as $addReklamacjeResponseErrorItem) {
            ...
            if (!$addReklamacjeResponseErrorItem instanceof \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType[] $error
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\AddReklamacjeResponse
     */
    ...
    public static function validateReklamacjaInfoForArrayConstraintsFromSetReklamacjaInfo(array $values = [])
    {
        ...
        foreach ($values as $addReklamacjeResponseReklamacjaInfoItem) {
            // validation for constraint: itemType
            if (!$addReklamacjeResponseReklamacjaInfoItem instanceof \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ReklamacjaInfoType) {
