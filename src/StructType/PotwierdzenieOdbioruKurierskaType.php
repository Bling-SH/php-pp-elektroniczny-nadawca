...
class PotwierdzenieOdbioruKurierskaType extends AbstractStructBase
{
     ...
     * @param int $ilosc
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\PotwierdzenieOdbioruKurierskaType
     */
     ...
     * Set sposob value.
     *
     * @uses \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::valueIsValid()
     * @uses \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::getValidValues()
     *
    ...
    public function setSposob($sposob = null)
    {
        ...
        if (!\Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::valueIsValid($sposob)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType', is_array($sposob) ? implode(', ', $sposob) : var_export($sposob, true), implode(', ', \Bling\PocztaPolska\ElektronicznyNadawca\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::getValidValues())), __LINE__);
        }
        $this->sposob = $sposob;
