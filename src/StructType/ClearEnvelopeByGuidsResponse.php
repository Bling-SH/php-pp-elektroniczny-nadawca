...
class ClearEnvelopeByGuidsResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(array $values = [])
    {
        ...
        foreach ($values as $clearEnvelopeByGuidsResponseErrorItem) {
            ...
            if (!$clearEnvelopeByGuidsResponseErrorItem instanceof \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType) {
     ...
     * @param \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType[] $error
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ClearEnvelopeByGuidsResponse
     */
