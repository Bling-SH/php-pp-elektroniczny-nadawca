...
class UpdateEnvelopeBufor extends AbstractStructBase
{
    ...
    public static function validateBuforForArrayConstraintsFromSetBufor(array $values = [])
    {
        ...
        foreach ($values as $updateEnvelopeBuforBuforItem) {
            ...
            if (!$updateEnvelopeBuforBuforItem instanceof \Bling\PocztaPolska\ElektronicznyNadawca\StructType\BuforType) {
     ...
     * @param \Bling\PocztaPolska\ElektronicznyNadawca\StructType\BuforType[] $bufor
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\UpdateEnvelopeBufor
     */
