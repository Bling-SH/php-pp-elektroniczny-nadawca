...
class GetEPOStatus extends AbstractStructBase
{
     ...
     */
    public function __construct(array $guid = [], $endedOnly = null, $idEnvelope = null, $withBioepo = null)
    {
        $this
            ->setGuid($guid)
    ...
    public static function validateGuidForLengthConstraintFromSetGuid($values)
    {
        ...
        foreach ($values as $getEPOStatusGuidItem) {
            ...
            if (32 !== mb_strlen($getEPOStatusGuidItem)) {
     ...
     * @param string[] $guid
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\GetEPOStatus
     */
