...
class GetPrintForParcel extends AbstractStructBase
{
     ...
     * - minOccurs: 1.
     *
     * @var \Bling\PocztaPolska\ElektronicznyNadawca\StructType\PrintType
     */
    public $type;
     ...
     *
     * @param string[]                                                      $guid
     * @param \Bling\PocztaPolska\ElektronicznyNadawca\StructType\PrintType $type
     */
    public function __construct(array $guid = [], \Bling\PocztaPolska\ElektronicznyNadawca\StructType\PrintType $type = null)
    {
        $this
            ->setGuid($guid)
            ->setType($type);
    ...
    public static function validateGuidForLengthConstraintFromSetGuid($values)
    {
        ...
        foreach ($values as $getPrintForParcelGuidItem) {
            ...
            if (32 !== mb_strlen($getPrintForParcelGuidItem)) {
     ...
     * @param string[] $guid
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\GetPrintForParcel
     */
     ...
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\GetPrintForParcel
     */
    public function setType(\Bling\PocztaPolska\ElektronicznyNadawca\StructType\PrintType $type = null)
    {
        $this->type = $type;
