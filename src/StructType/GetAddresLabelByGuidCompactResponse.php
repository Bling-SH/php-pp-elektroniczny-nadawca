...
class GetAddresLabelByGuidCompactResponse extends AbstractStructBase
{
     ...
     * @param string $pdfContent
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\GetAddresLabelByGuidCompactResponse
     */
    ...
    public static function validateErrorForArrayConstraintsFromSetError(array $values = [])
    {
        ...
        foreach ($values as $getAddresLabelByGuidCompactResponseErrorItem) {
            ...
            if (!$getAddresLabelByGuidCompactResponseErrorItem instanceof \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType) {
