...
class AddRozbieznoscDoZapowiedziFakturResponse extends AbstractStructBase
{
    ...
    public static function validateErrorForArrayConstraintsFromSetError(array $values = [])
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $addRozbieznoscDoZapowiedziFakturResponseErrorItem) {
            // validation for constraint: itemType
            if (!$addRozbieznoscDoZapowiedziFakturResponseErrorItem instanceof \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType) {
                $invalidValues[] = is_object($addRozbieznoscDoZapowiedziFakturResponseErrorItem) ? get_class($addRozbieznoscDoZapowiedziFakturResponseErrorItem) : sprintf('%s(%s)', gettype($addRozbieznoscDoZapowiedziFakturResponseErrorItem), var_export($addRozbieznoscDoZapowiedziFakturResponseErrorItem, true));
            }
        }
     ...
     * @param \Bling\PocztaPolska\ElektronicznyNadawca\StructType\ErrorType[] $error
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\AddRozbieznoscDoZapowiedziFakturResponse
     */
