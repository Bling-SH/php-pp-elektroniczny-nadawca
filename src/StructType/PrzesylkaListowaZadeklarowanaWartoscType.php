...
class PrzesylkaListowaZadeklarowanaWartoscType extends PrzesylkaRejestrowanaType
{
     ...
     * @param int    $masa
     */
    public function __construct($kategoria = null, $gabaryt = null, $posteRestante = false, $wartosc = null, $iloscPotwierdzenOdbioru = 0, $masa = null)
    {
        $this
     ...
     * @param string $kategoria
     *
     * @return \Bling\PocztaPolska\ElektronicznyNadawca\StructType\PrzesylkaListowaZadeklarowanaWartoscType
     */
